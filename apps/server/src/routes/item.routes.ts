...
/**
 * @openapi
 * /api/items/{itemId}/mark-used:
 *   post:
 *     tags:
 *       - Items
 *     summary: Mark item as used
 *     description: Update the last used timestamp for a bookmark item
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *         description: Internal server error
 */
router.post('/:itemId/mark-used', param('itemId').isUUID(), itemController.markItemAsUsed);
 ...
 *     tags:
 *       - Items
 *     summary: Search bookmark items
 *     description: Search for bookmark items by title or URL
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *         description: Internal server error
 */
router.get('/search', query('q').notEmpty().withMessage('Search query is required'), itemController.searchItems);
 ...
 *     tags:
 *       - Items
 *     summary: Get recently used items
 *     description: Retrieve recently used bookmark items for the authenticated user
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of recently used items
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *         description: Internal server error
 */
router.get('/recent', itemController.getRecentlyUsedItems);
